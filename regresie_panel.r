...
# Functie pentru restructurarea datelor in format panel (long format)
...
cat("Informatii despre panelul de date:\n")
...
cat("Analiza panel data completa! Rezultatele au fost salvate in 'rezultate_panel_data.txt'\n")